...
from .views import contact_us, fashion_consultations, home, ProductDetailView, ProductListView, product_care_guides, product_contact_us
...
urlpatterns = [
    ...
    path('<slug:slug>/contact-us/', product_contact_us, name='product_contact_us'),  # Add new URL
